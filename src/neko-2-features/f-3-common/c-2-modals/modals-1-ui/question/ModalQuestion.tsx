...
interface IModalQuestion {
    ...
    trueStyles?: CSSProperties; falseStyles?: CSSProperties;
    buttonTrue?: ReactNode; buttonFalse?: ReactNode;
...
const ModalQuestion: React.FC<IModalQuestion> = (
    ...
    return (
        ...
        >
            ...
            <div style={{width: '100%', ...FlexAlignCenterSpaceAround, ...buttonStyles}}>
